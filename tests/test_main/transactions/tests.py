...
from tests.test_main.transactions.models import Reporter
...
class AtomicTests(TransactionTestCase):
    ...
    def test_decorator_syntax_rollback(self):
        ...
        with assertRaisesRegex(self, Exception, "Oops"):
            make_reporter()
...
class AtomicMySQLTests(TransactionTestCase):
    ...
    def test_implicit_savepoint_rollback(self):
        ...
        with assertRaisesRegex(self, OperationalError, 'Deadlock found'):
