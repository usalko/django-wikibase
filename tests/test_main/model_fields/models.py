...
class Bar(models.Model):
    ...
    a = models.ForeignKey(Foo, models.CASCADE,
                          default=get_foo, related_name='bars')
...
class VerboseNameField(models.Model):
    ...
    field4 = models.CharField("verbose field4", max_length=99, validators=[
                              validators.validate_comma_separated_integer_list])
    field5 = models.DateField("verbose field5")
    field6 = models.DateTimeField("verbose field6")
    field7 = models.DecimalField(
        "verbose field7", max_digits=6, decimal_places=1)
...
class AllFieldsModel(models.Model):
    ...
    csv = models.CharField(max_length=10, validators=[
                           validators.validate_comma_separated_integer_list])
