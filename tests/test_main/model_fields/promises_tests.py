...
class PromiseTest(SimpleTestCase):
    ...
    @unittest.skipIf(PY3, 'Python 3 has no `long` type.')
    ...
    def test_CharField(self):
        lazy_func = lazy(lambda: '', text_type)
        self.assertIsInstance(CharField().get_prep_value(lazy_func()), text_type)
        lazy_func = lazy(lambda: 0, int)
        self.assertIsInstance(CharField().get_prep_value(lazy_func()), text_type)

    def test_CommaSeparatedIntegerField(self):
        lazy_func = lazy(lambda: '1,2', text_type)
        self.assertIsInstance(CommaSeparatedIntegerField().get_prep_value(lazy_func()), text_type)
        lazy_func = lazy(lambda: 0, int)
        self.assertIsInstance(CommaSeparatedIntegerField().get_prep_value(lazy_func()), text_type)
    ...
    def test_EmailField(self):
        lazy_func = lazy(lambda: 'mailbox@domain.com', text_type)
        self.assertIsInstance(EmailField().get_prep_value(lazy_func()), text_type)

    def test_FileField(self):
        lazy_func = lazy(lambda: 'filename.ext', text_type)
        self.assertIsInstance(FileField().get_prep_value(lazy_func()), text_type)
        lazy_func = lazy(lambda: 0, int)
        self.assertIsInstance(FileField().get_prep_value(lazy_func()), text_type)

    def test_FilePathField(self):
        lazy_func = lazy(lambda: 'tests.py', text_type)
        self.assertIsInstance(FilePathField().get_prep_value(lazy_func()), text_type)
        lazy_func = lazy(lambda: 0, int)
        self.assertIsInstance(FilePathField().get_prep_value(lazy_func()), text_type)
    ...
    def test_ImageField(self):
        lazy_func = lazy(lambda: 'filename.ext', text_type)
        self.assertIsInstance(ImageField().get_prep_value(lazy_func()), text_type)
    ...
    def test_IPAddressField(self):
        lazy_func = lazy(lambda: '127.0.0.1', text_type)
        self.assertIsInstance(IPAddressField().get_prep_value(lazy_func()), text_type)
        lazy_func = lazy(lambda: 0, int)
        self.assertIsInstance(IPAddressField().get_prep_value(lazy_func()), text_type)

    def test_GenericIPAddressField(self):
        lazy_func = lazy(lambda: '127.0.0.1', text_type)
        self.assertIsInstance(GenericIPAddressField().get_prep_value(lazy_func()), text_type)
        lazy_func = lazy(lambda: 0, int)
        self.assertIsInstance(GenericIPAddressField().get_prep_value(lazy_func()), text_type)
    ...
    def test_SlugField(self):
        lazy_func = lazy(lambda: 'slug', text_type)
        self.assertIsInstance(SlugField().get_prep_value(lazy_func()), text_type)
        lazy_func = lazy(lambda: 0, int)
        self.assertIsInstance(SlugField().get_prep_value(lazy_func()), text_type)
    ...
    def test_TextField(self):
        lazy_func = lazy(lambda: 'Abc', text_type)
        self.assertIsInstance(TextField().get_prep_value(lazy_func()), text_type)
        lazy_func = lazy(lambda: 0, int)
        self.assertIsInstance(TextField().get_prep_value(lazy_func()), text_type)
    ...
    def test_URLField(self):
        lazy_func = lazy(lambda: 'http://domain.com', text_type)
        self.assertIsInstance(URLField().get_prep_value(lazy_func()), text_type)
