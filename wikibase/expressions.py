...
def wikibase_fix_value_expr(self, compiler, connection):
    """
    Wikibase fails to resolve some params replacement
...
# RawSQL.as_wikibase = wikibase_fix_value_expr
# Value.as_wikibase = wikibase_fix_value_expr
